...
class CommentForm extends React.Component {
    ...
    RenderComments (){
      ...
      handleSubmit(values) {
       ...
       //console.log(JSON.stringify(values).split(',').length) //for debug
        if(JSON.stringify(values).split(',').length !== 3)
        alert('Please fill in all field in the message box!')
        else
        this.setState({
            isModalOpen: !this.state.isModalOpen,
                            ...
                            <Row className="form-group">
                                <Col>
                                    <Control.select model=".rating" name="rating"
                                        ...
                                        <option>Please choose a rating for this dish </option>
                                        <option>1</option>
                                        <option>2</option>
                                        <option>3</option>
                                        <option>4</option>
